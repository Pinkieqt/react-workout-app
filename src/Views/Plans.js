    ...
    <div className={`p-3 min-h-screen bg-${theme}-bg`}>
      <div className={`w-full flex justify-center flex-wrap container mx-auto`}>
        <div className={`w-full mt-5 sm:mt-5 md:mt-10`}>
          ...
          <h3
            className={`text-center text-${theme}-tsec pt-6 pb-1 w-full sm:w-full md:w-auto`}
          >
            PPL program znamená Push/Pull/Legs. Cvičení tedy probíhá 3 dny po
            sobě.
          </h3>
          <h3
            className={`text-center text-${theme}-tsec w-full sm:w-full md:w-auto`}
          >
        ...
        >
          <table className={`w-full table-auto text-center py-2h-auto`}>
            <thead>
              <tr>
                <th
                  className={`px-4 pt-6 sm:pt-6 md:pt-0 pb-8 text-${theme}-tpr font-bold text-xl`}
                  colSpan="2"
                >
                  První cyklus
                </th>
